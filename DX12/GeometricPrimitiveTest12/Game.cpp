...
void Game::CreateDevice()
{
    ...
    //m_effect = std::make_unique<BasicEffect>(m_d3dDevice.Get(), EffectFlags::Lighting | EffectFlags::Texture, pd);
    m_effect = std::make_unique<BasicEffect>(m_d3dDevice.Get(), EffectFlags::PerPixelLighting | EffectFlags::Texture, pd);
