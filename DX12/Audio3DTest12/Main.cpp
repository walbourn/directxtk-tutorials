...
LPCWSTR g_szAppName = L"Audio3DTest12";
...
int WINAPI wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
    ...
    HDEVNOTIFY hNewAudio = nullptr;
    {
        ...
        wcex.lpszClassName = L"Audio3DTest12WindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"Audio3DTest12WindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
            CW_USEDEFAULT, CW_USEDEFAULT, rc.right - rc.left, rc.bottom - rc.top, nullptr, nullptr, hInstance,
            nullptr);
        // TODO: Change to CreateWindowExW(WS_EX_TOPMOST, L"Audio3DTest12WindowClass", g_szAppName, WS_POPUP,
