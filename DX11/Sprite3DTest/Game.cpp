...
void Game::Render()
{
    ...
    //Vector3 texPos(1.f, 1.f, 2.f);

//    m_world = Matrix::CreateConstrainedBillboard(texPos, texPos - m_camPos, Vector3::Down);
    //m_world = Matrix::CreateScale(1.f, -1.f, 1.f) * Matrix::CreateTranslation(texPos);
    m_world = Matrix::Identity;

    XMMATRIX matrix = m_world * m_view * m_proj;
    ...
    m_font->DrawString(m_spriteBatch.get(), output, Vector2(0.f,0.f), Colors::White, 0.f, origin, .25f, SpriteEffects_None, 2.f);
...
void Game::CreateResources()
{
    ...
    m_camPos = Vector3(2.f, 2.f, 2.f);

    m_view = Matrix::CreateLookAt(m_camPos, Vector3::Zero, Vector3::UnitY);
